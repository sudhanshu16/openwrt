...
define Device/buffalo_wzr-hp-g302h-a1a0
  ATH_SOC := ar7242
  DEVICE_VENDOR := Buffalo
  DEVICE_MODEL := WZR-HP-G302H A1A0
  DEVICE_RAM := 64
  DEVICE_FLASH := 32
  DEVICE_PACKAGES := kmod-usb-core kmod-usb2 kmod-usb-ledtrig-usbport
  IMAGE_SIZE := 32128k
...
define Device/pisen_wmm003n
  ...
  ATH_SOC := ar9331
  DEVICE_VENDOR := PISEN
  DEVICE_MODEL := WMM003N
  DEVICE_VARIANT := Cloud Easy Power
  DEVICE_RAM := 64
